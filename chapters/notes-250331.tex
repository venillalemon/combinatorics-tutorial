\chapter{Combinatorics 3.31}
\label{ch:250331}

\section{$(1,\sqrt{2}]$}

\notefigure{notes/250331-01.png}
...
\section{$\Delta\leq50,\alpha\leq99$, 问 $\max n=|G|$}

\notefigure{notes/250331-03.png}
...
\begin{quotation}
\textbf{Thm.} $\alpha\geq\frac{n}{\Delta+1}$.
\end{quotation}

直观上，先选出独立集 $D$，剩下所有的点一定是某个独立集内点的邻居。因此 $n\leq\sum_{v\in D}(N(v)+1)\leq\alpha(\Delta+1)$.

\begin{quotation}
\textbf{Thm.} (Turan) $\alpha\geq\frac{n}{\overline{d}+1}$.
\end{quotation}
